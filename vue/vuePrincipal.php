		...
		<div class="row ">
			...
			<div class="banner-area mx-auto" style = "max-width: 100%;" >
				...
				<div class="col-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <p class="card-text"><strong>2015-2018 - Bac S option ISN </strong></p>
                                    <p class="card-text">Lycée Sud Médoc - Taillan Médoc</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title"><img src = "images/competence.png" alt = "Logo d'ordinateur">&nbsp;&nbsp;Compétences</h5>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <p class="card-text"><strong>Juillet 2019 (2 mois) - Le Fujiyama</strong></p>
                                    <p class="card-text">Emploi saisonnier polyvalent (aide en cuisine, livraison, serveur)</p>
                                </li>
                            </ul>
                        </div>
                    </div>
  				...
  				<img class="card-img-top" src="images/php.png" alt="logo php/mysql">
  					<div class="card-body m-0">
    					 ...
    					 <div class = "text-center">
    					 	<a href="#Projets" class="btn btn-primary m-2">Voir la doc</a><a href="#Projets" class="btn btn-primary m-2">Voir le code</a>
    					 </div>
