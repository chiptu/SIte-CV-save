...
<div class = "row">	
	...
	<div class ="col-12">
		...
		<div class = "container bg-white h-100" id="doc">
			...
			<p> L'application permet aussi de modifier , supprimer , ajouter des contacts et serveurs.</p>
			...
			<h2 class="pt-5" id ="2">Python</h2><br>
			<p> Python est un langage de programmation plus souvent utilisé dans le big data et l'ia , il est apprécié des développeurs notamment pour sa simplicité de syntax.  </p><br>
